...
public class ReaderAction {
	...
	public final static ReaderAction ZOOM_IN = new ReaderAction("ZOOM_IN", R.string.mi_font_size_increase, ReaderCommand.DCMD_ZOOM_IN, 1).setCanRepeat().setIconId(R.drawable.cr3_font_size_increase); //,  R.id.cr3_mi_font_size_increase
	public final static ReaderAction ZOOM_OUT = new ReaderAction("ZOOM_OUT", R.string.mi_font_size_decrease, ReaderCommand.DCMD_ZOOM_OUT, 1).setCanRepeat().setIconId(R.drawable.cr3_font_size_decrease); //,  R.id.cr3_mi_font_size_decrease
	...
	public final static ReaderAction TOGGLE_ORIENTATION = new ReaderAction("TOGGLE_ORIENTATION", R.string.action_toggle_screen_orientation, ReaderCommand.DCMD_TOGGLE_ORIENTATION, 0 ).setIconId(R.drawable.cr3_button_rotate);
	...
	public final static ReaderAction HOME_SCREEN = new ReaderAction("HOME_SCREEN", R.string.action_exit_home_screen, ReaderCommand.DCMD_SHOW_HOME_SCREEN, 0 ).setIconId(R.drawable.cr3_browser_folder_root);
